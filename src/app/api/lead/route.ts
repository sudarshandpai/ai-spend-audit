...
export async function POST(req: NextRequest) {
  try {
    ...
    const monthlySavings =
      audit?.total_monthly_savings?.toFixed(0) || "0";

    const annualSavings =
      audit?.total_annual_savings?.toFixed(0) || "0";
    ...
    const toolRows =
      audit?.audit_results
        ...
        <tr>
          ...
          <td style="padding:10px 12px;border-bottom:1px solid #f1f5f9;color:#10b981;font-weight:600;">
            $${r.estimatedCost.toFixed(0)}/mo
          </td>
          ...
          <td style="padding:10px 12px;border-bottom:1px solid #f1f5f9;">
            ${
              r.savings > 0
                ? `
                <span style="background:#fff7ed;color:#ea580c;padding:2px 8px;border-radius:20px;font-size:12px;font-weight:600;">
                  Save $${r.savings.toFixed(0)}/mo
                </span>
              `
                : `
                <span style="background:#f0fdf4;color:#16a34a;padding:2px 8px;border-radius:20px;font-size:12px;">
                  ✓ Optimal
                </span>
              `
            }
...
<p style="margin:0 0 4px;color:#6ee7b7;font-size:12px;text-transform:uppercase;letter-spacing:1px;">
Savings identified
</p>

<h2 style="margin:0;color:#ffffff;font-size:36px;font-weight:900;">
$${monthlySavings}
...
<p style="margin:4px 0 0;color:#a7f3d0;font-size:15px;">
...
<p style="margin:0 0 6px;color:#10b981;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:1px;">
AI Summary
</p>
...
<h3 style="margin:0 0 16px;color:#0f1117;font-size:15px;font-weight:700;">
...
<th style="padding:10px 12px;text-align:left;font-size:11px;color:#94a3b8;font-weight:600;text-transform:uppercase;">
Tool
</th>
...
<h3 style="margin:0 0 8px;color:#ffffff;font-size:16px;">
...
style="display:inline-block;background:#10b981;color:#ffffff;text-decoration:none;padding:12px 24px;border-radius:8px;font-weight:700;font-size:14px;">
...
<a
href="https://ai-spend-audit-lovat.vercel.app/results/${audit?.share_id || ""}"
...
Generated by <strong>SpendLens</strong>
</p>
